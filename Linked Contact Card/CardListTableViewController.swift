...
class CardListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.fullNameLabel.text = "Ben Duke"
        cell.jobTitleLabel.text = "IOS Developer"
        cell.companyLabel.text = "Self Employed"
        return cell
    }
    ...
    */
    @IBAction func unwindToCardList(sender: UIStoryboardSegue){
        if let sourceViewController = sender.source as? CardTableViewController, let card = sourceViewController.card {
